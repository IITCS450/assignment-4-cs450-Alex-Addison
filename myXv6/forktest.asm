    ...
    1044:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
    1049:	68 14 14 00 00       	push   $0x1414
    104e:	e8 5d 01 00 00       	call   11b0 <strlen>
    1053:	83 c4 0c             	add    $0xc,%esp
    1056:	50                   	push   %eax
    1057:	68 14 14 00 00       	push   $0x1414
    105c:	6a 01                	push   $0x1
  ...
  write(fd, s, strlen(s));
    ...
    10ab:	68 46 14 00 00       	push   $0x1446
    10b0:	e8 fb 00 00 00       	call   11b0 <strlen>
    10b5:	83 c4 0c             	add    $0xc,%esp
    10b8:	50                   	push   %eax
    10b9:	68 46 14 00 00       	push   $0x1446
    10be:	6a 01                	push   $0x1
  ...
  write(fd, s, strlen(s));
    ...
    10d2:	68 1f 14 00 00       	push   $0x141f
    10d7:	e8 d4 00 00 00       	call   11b0 <strlen>
    10dc:	83 c4 0c             	add    $0xc,%esp
    10df:	50                   	push   %eax
    10e0:	68 1f 14 00 00       	push   $0x141f
    10e5:	6a 01                	push   $0x1
    ...
    10f1:	52                   	push   %edx
    10f2:	52                   	push   %edx
    10f3:	68 33 14 00 00       	push   $0x1433
    10f8:	6a 01                	push   $0x1
    ...
    110a:	68 54 14 00 00       	push   $0x1454
    110f:	6a 01                	push   $0x1
