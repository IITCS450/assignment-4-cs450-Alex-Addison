...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    1024:	6a 02                	push   $0x2
    1026:	68 49 23 00 00       	push   $0x2349
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    1040:	80 3d e2 29 00 00 20 	cmpb   $0x20,0x29e2
...
fork1(void)
{
  ...
  printf(2, "$ ");
    ...
    106a:	68 a8 22 00 00       	push   $0x22a8
    106f:	6a 02                	push   $0x2
    1071:	e8 0a 0f 00 00       	call   1f80 <printf>
  memset(buf, 0, nbuf);
    1076:	83 c4 0c             	add    $0xc,%esp
    1079:	6a 64                	push   $0x64
    107b:	6a 00                	push   $0x0
    107d:	68 e0 29 00 00       	push   $0x29e0
    1082:	e8 09 0c 00 00       	call   1c90 <memset>
  gets(buf, nbuf);
    1087:	58                   	pop    %eax
    1088:	5a                   	pop    %edx
    1089:	6a 64                	push   $0x64
    108b:	68 e0 29 00 00       	push   $0x29e0
    1090:	e8 5b 0c 00 00       	call   1cf0 <gets>
  if(buf[0] == 0) // EOF
    1095:	0f b6 05 e0 29 00 00 	movzbl 0x29e0,%eax
    ...
    10a7:	80 3d e1 29 00 00 64 	cmpb   $0x64,0x29e1
    ...
    10c3:	68 e0 29 00 00       	push   $0x29e0
    ...
    10d8:	68 e0 29 00 00       	push   $0x29e0
    10dd:	e8 7e 0b 00 00       	call   1c60 <strlen>
      if(chdir(buf+3) < 0)
    10e2:	c7 04 24 e3 29 00 00 	movl   $0x29e3,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
    10e9:	c6 80 df 29 00 00 00 	movb   $0x0,0x29df(%eax)
      if(chdir(buf+3) < 0)
    ...
    1100:	51                   	push   %ecx
    1101:	68 e3 29 00 00       	push   $0x29e3
    1106:	68 51 23 00 00       	push   $0x2351
    110b:	6a 02                	push   $0x2
    110d:	e8 6e 0e 00 00       	call   1f80 <printf>
  ...
  exit();
    ...
    1122:	68 ab 22 00 00       	push   $0x22ab
...
00001130 <getcmd>:
{
  ...
  printf(2, "$ ");
    ...
    113e:	68 a8 22 00 00       	push   $0x22a8
    1143:	6a 02                	push   $0x2
    1145:	e8 36 0e 00 00       	call   1f80 <printf>
  memset(buf, 0, nbuf);
...
00001170 <panic>:
{
  ...
  printf(2, "%s\n", s);
    ...
    1179:	68 45 23 00 00       	push   $0x2345
    117e:	6a 02                	push   $0x2
    1180:	e8 fb 0d 00 00       	call   1f80 <printf>
  exit();
...
00001190 <fork1>:
{
  ...
  return pid;
    ...
    11a5:	68 ab 22 00 00       	push   $0x22ab
...
000011b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    11c9:	ff 24 85 60 23 00 00 	jmp    *0x2360(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    11e6:	ff 73 04             	pushl  0x4(%ebx)
    11e9:	68 b7 22 00 00       	push   $0x22b7
    11ee:	6a 02                	push   $0x2
    11f0:	e8 8b 0d 00 00       	call   1f80 <printf>
    break;
    ...
    1247:	ff 75 f0             	pushl  -0x10(%ebp)
    124a:	e8 fc 0b 00 00       	call   1e4b <close>
    close(p[1]);
    124f:	58                   	pop    %eax
    1250:	ff 75 f4             	pushl  -0xc(%ebp)
    ...
    1278:	ff 73 08             	pushl  0x8(%ebx)
    127b:	e8 30 ff ff ff       	call   11b0 <runcmd>
    close(rcmd->fd);
    1280:	83 ec 0c             	sub    $0xc,%esp
    1283:	ff 73 14             	pushl  0x14(%ebx)
    1286:	e8 c0 0b 00 00       	call   1e4b <close>
    if(open(rcmd->file, rcmd->mode) < 0){
    128b:	58                   	pop    %eax
    128c:	5a                   	pop    %edx
    128d:	ff 73 10             	pushl  0x10(%ebx)
    1290:	ff 73 08             	pushl  0x8(%ebx)
    ...
    12a2:	ff 73 04             	pushl  0x4(%ebx)
    12a5:	e8 06 ff ff ff       	call   11b0 <runcmd>
    panic("runcmd");
    12aa:	83 ec 0c             	sub    $0xc,%esp
    12ad:	68 b0 22 00 00       	push   $0x22b0
    12b2:	e8 b9 fe ff ff       	call   1170 <panic>
      printf(2, "open %s failed\n", rcmd->file);
    12b7:	51                   	push   %ecx
    12b8:	ff 73 08             	pushl  0x8(%ebx)
    12bb:	68 c7 22 00 00       	push   $0x22c7
    12c0:	6a 02                	push   $0x2
    12c2:	e8 b9 0c 00 00       	call   1f80 <printf>
      exit();
    12c7:	e8 57 0b 00 00       	call   1e23 <exit>
      panic("pipe");
    12cc:	83 ec 0c             	sub    $0xc,%esp
    12cf:	68 d7 22 00 00       	push   $0x22d7
    ...
    12de:	e8 68 0b 00 00       	call   1e4b <close>
      dup(p[1]);
    12e3:	58                   	pop    %eax
    12e4:	ff 75 f4             	pushl  -0xc(%ebp)
    12e7:	e8 af 0b 00 00       	call   1e9b <dup>
      close(p[0]);
    12ec:	58                   	pop    %eax
    12ed:	ff 75 f0             	pushl  -0x10(%ebp)
    ...
    130c:	e8 3a 0b 00 00       	call   1e4b <close>
      dup(p[0]);
    1311:	5a                   	pop    %edx
    1312:	ff 75 f0             	pushl  -0x10(%ebp)
    1315:	e8 81 0b 00 00       	call   1e9b <dup>
      close(p[0]);
    131a:	59                   	pop    %ecx
    131b:	ff 75 f0             	pushl  -0x10(%ebp)
    131e:	e8 28 0b 00 00       	call   1e4b <close>
      close(p[1]);
    1323:	58                   	pop    %eax
    1324:	ff 75 f4             	pushl  -0xc(%ebp)
    1327:	e8 1f 0b 00 00       	call   1e4b <close>
      runcmd(pcmd->right);
    132c:	58                   	pop    %eax
    132d:	ff 73 08             	pushl  0x8(%ebx)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1349:	e8 62 0e 00 00       	call   21b0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1379:	e8 32 0e 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    13c7:	6a 0c                	push   $0xc
    13c9:	e8 e2 0d 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    1407:	6a 0c                	push   $0xc
    1409:	e8 a2 0d 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    1447:	6a 08                	push   $0x8
    1449:	e8 62 0d 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
    ...
    1479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    149d:	50                   	push   %eax
    149e:	68 cc 29 00 00       	push   $0x29cc
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    14ed:	50                   	push   %eax
    14ee:	68 cc 29 00 00       	push   $0x29cc
  ...
  *ps = s;
  ...
  if(eq)
    ...
    152e:	50                   	push   %eax
    152f:	68 c4 29 00 00       	push   $0x29c4
    ...
    1550:	56                   	push   %esi
    1551:	68 cc 29 00 00       	push   $0x29cc
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    15fd:	50                   	push   %eax
    15fe:	68 cc 29 00 00       	push   $0x29cc
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    1663:	68 f9 22 00 00       	push   $0x22f9
    1668:	53                   	push   %ebx
    1669:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
    16c2:	e8 e9 0a 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
    1721:	e8 8a 0a 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
    ...
    177e:	68 dc 22 00 00       	push   $0x22dc
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    179f:	68 fc 22 00 00       	push   $0x22fc
    17a4:	57                   	push   %edi
    17a5:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    17bd:	e8 ee 09 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    1806:	68 13 23 00 00       	push   $0x2313
    180b:	57                   	push   %edi
    180c:	56                   	push   %esi
    ...
    1850:	68 05 23 00 00       	push   $0x2305
  ...
  cmd->eargv[argc] = 0;
    ...
    1899:	68 fe 22 00 00       	push   $0x22fe
...
000018b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
    ...
    18c9:	68 18 23 00 00       	push   $0x2318
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
    190d:	e8 9e 08 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00001940 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1972:	e8 39 08 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
    ...
    199b:	68 1a 23 00 00       	push   $0x231a
    19a0:	57                   	push   %edi
    19a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
    ...
    19b1:	68 16 23 00 00       	push   $0x2316
    19b6:	57                   	push   %edi
    19b7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
    19ed:	e8 be 07 00 00       	call   21b0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00001a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
    1a2f:	68 fc 22 00 00       	push   $0x22fc
    1a34:	56                   	push   %esi
    1a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
    ...
    1a59:	68 38 23 00 00       	push   $0x2338
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    1ac9:	ff 24 85 78 23 00 00 	jmp    *0x2378(,%eax,4)
  ...
  case LIST:
    ...
    1ad3:	ff 73 04             	pushl  0x4(%ebx)
    1ad6:	e8 d5 ff ff ff       	call   1ab0 <nulterminate>
    nulterminate(lcmd->right);
    1adb:	58                   	pop    %eax
    1adc:	ff 73 08             	pushl  0x8(%ebx)
    ...
    1b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
    ...
    1b83:	68 c6 22 00 00       	push   $0x22c6
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    1bae:	52                   	push   %edx
    1baf:	50                   	push   %eax
    1bb0:	68 3a 23 00 00       	push   $0x233a
    1bb5:	6a 02                	push   $0x2
    1bb7:	e8 c4 03 00 00       	call   1f80 <printf>
    panic("syntax");
    1bbc:	c7 04 24 fe 22 00 00 	movl   $0x22fe,(%esp)
...
SYSCALL(uptime)
    ...
    1ec5:	66 90                	xchg   %ax,%ax
    1ec7:	66 90                	xchg   %ax,%ax
    1ec9:	66 90                	xchg   %ax,%ax
    1ecb:	66 90                	xchg   %ax,%ax
    1ecd:	66 90                	xchg   %ax,%ax
    1ecf:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    1ed4:	56                   	push   %esi
    1ed5:	53                   	push   %ebx
    1ed6:	83 ec 3c             	sub    $0x3c,%esp
    1ed9:	89 4d c4             	mov    %ecx,-0x3c(%ebp)
  uint x;
  ...
  if(sgn && xx < 0){
    neg = 1;
    x = -xx;
    1edc:	89 d1                	mov    %edx,%ecx
{
    1ede:	89 45 b8             	mov    %eax,-0x48(%ebp)
  if(sgn && xx < 0){
    1ee1:	85 d2                	test   %edx,%edx
    1ee3:	0f 89 7f 00 00 00    	jns    1f68 <printint+0x98>
    1ee9:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    1eed:	74 79                	je     1f68 <printint+0x98>
    neg = 1;
    1eef:	c7 45 bc 01 00 00 00 	movl   $0x1,-0x44(%ebp)
    x = -xx;
    1ef6:	f7 d9                	neg    %ecx
  } else {
    x = xx;
  ...
  i = 0;
    1ef8:	31 db                	xor    %ebx,%ebx
    1efa:	8d 75 d7             	lea    -0x29(%ebp),%esi
    1efd:	8d 76 00             	lea    0x0(%esi),%esi
  do{
    buf[i++] = digits[x % base];
    1f00:	89 c8                	mov    %ecx,%eax
    1f02:	31 d2                	xor    %edx,%edx
    1f04:	89 cf                	mov    %ecx,%edi
    1f06:	f7 75 c4             	divl   -0x3c(%ebp)
    1f09:	0f b6 92 f0 23 00 00 	movzbl 0x23f0(%edx),%edx
    1f10:	89 45 c0             	mov    %eax,-0x40(%ebp)
    1f13:	89 d8                	mov    %ebx,%eax
    1f15:	8d 5b 01             	lea    0x1(%ebx),%ebx
  }while((x /= base) != 0);
    1f18:	8b 4d c0             	mov    -0x40(%ebp),%ecx
    buf[i++] = digits[x % base];
    1f1b:	88 14 1e             	mov    %dl,(%esi,%ebx,1)
  }while((x /= base) != 0);
    1f1e:	39 7d c4             	cmp    %edi,-0x3c(%ebp)
    1f21:	76 dd                	jbe    1f00 <printint+0x30>
  if(neg)
    1f23:	8b 4d bc             	mov    -0x44(%ebp),%ecx
    1f26:	85 c9                	test   %ecx,%ecx
    1f28:	74 0c                	je     1f36 <printint+0x66>
    buf[i++] = '-';
    1f2a:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    buf[i++] = digits[x % base];
    1f2f:	89 d8                	mov    %ebx,%eax
    buf[i++] = '-';
    1f31:	ba 2d 00 00 00       	mov    $0x2d,%edx

  while(--i >= 0)
    1f36:	8b 7d b8             	mov    -0x48(%ebp),%edi
    1f39:	8d 5c 05 d7          	lea    -0x29(%ebp,%eax,1),%ebx
    1f3d:	eb 07                	jmp    1f46 <printint+0x76>
    1f3f:	90                   	nop
    putc(fd, buf[i]);
    1f40:	0f b6 13             	movzbl (%ebx),%edx
    1f43:	83 eb 01             	sub    $0x1,%ebx
  write(fd, &c, 1);
    1f46:	83 ec 04             	sub    $0x4,%esp
    1f49:	88 55 d7             	mov    %dl,-0x29(%ebp)
    1f4c:	6a 01                	push   $0x1
    1f4e:	56                   	push   %esi
    1f4f:	57                   	push   %edi
    1f50:	e8 ee fe ff ff       	call   1e43 <write>
  while(--i >= 0)
    1f55:	83 c4 10             	add    $0x10,%esp
    1f58:	39 de                	cmp    %ebx,%esi
    1f5a:	75 e4                	jne    1f40 <printint+0x70>
}
    ...
    1f62:	5d                   	pop    %ebp
    1f63:	c3                   	ret    
    1f64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  neg = 0;
    1f68:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
    1f6f:	eb 87                	jmp    1ef8 <printint+0x28>
    1f71:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1f78:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1f7f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    1f89:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    1f8c:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    1f8f:	0f b6 13             	movzbl (%ebx),%edx
    1f92:	84 d2                	test   %dl,%dl
    1f94:	74 6a                	je     2000 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    1f96:	8d 45 10             	lea    0x10(%ebp),%eax
    1f99:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    1f9c:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    1f9f:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    1fa1:	89 45 d0             	mov    %eax,-0x30(%ebp)
    1fa4:	eb 36                	jmp    1fdc <printf+0x5c>
    1fa6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    1fad:	8d 76 00             	lea    0x0(%esi),%esi
    1fb0:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    1fb3:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    1fb8:	83 f8 25             	cmp    $0x25,%eax
    1fbb:	74 15                	je     1fd2 <printf+0x52>
  write(fd, &c, 1);
    1fbd:	83 ec 04             	sub    $0x4,%esp
    1fc0:	88 55 e7             	mov    %dl,-0x19(%ebp)
    1fc3:	6a 01                	push   $0x1
    1fc5:	57                   	push   %edi
    1fc6:	56                   	push   %esi
    1fc7:	e8 77 fe ff ff       	call   1e43 <write>
    1fcc:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    1fcf:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    1fd2:	0f b6 13             	movzbl (%ebx),%edx
    1fd5:	83 c3 01             	add    $0x1,%ebx
    1fd8:	84 d2                	test   %dl,%dl
    1fda:	74 24                	je     2000 <printf+0x80>
    c = fmt[i] & 0xff;
    1fdc:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    1fdf:	85 c9                	test   %ecx,%ecx
    1fe1:	74 cd                	je     1fb0 <printf+0x30>
      }
    } else if(state == '%'){
    1fe3:	83 f9 25             	cmp    $0x25,%ecx
    1fe6:	75 ea                	jne    1fd2 <printf+0x52>
      if(c == 'd'){
    1fe8:	83 f8 25             	cmp    $0x25,%eax
    1feb:	0f 84 07 01 00 00    	je     20f8 <printf+0x178>
    1ff1:	83 e8 63             	sub    $0x63,%eax
    1ff4:	83 f8 15             	cmp    $0x15,%eax
    1ff7:	77 17                	ja     2010 <printf+0x90>
    1ff9:	ff 24 85 98 23 00 00 	jmp    *0x2398(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    2013:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    2016:	6a 01                	push   $0x1
    2018:	57                   	push   %edi
    2019:	56                   	push   %esi
    201a:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    201e:	e8 20 fe ff ff       	call   1e43 <write>
        putc(fd, c);
    2023:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    2027:	83 c4 0c             	add    $0xc,%esp
    202a:	88 55 e7             	mov    %dl,-0x19(%ebp)
    202d:	6a 01                	push   $0x1
    202f:	57                   	push   %edi
    2030:	56                   	push   %esi
    2031:	e8 0d fe ff ff       	call   1e43 <write>
        putc(fd, c);
    2036:	83 c4 10             	add    $0x10,%esp
      state = 0;
    2039:	31 c9                	xor    %ecx,%ecx
    203b:	eb 95                	jmp    1fd2 <printf+0x52>
    203d:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    2040:	83 ec 0c             	sub    $0xc,%esp
    2043:	b9 10 00 00 00       	mov    $0x10,%ecx
    2048:	6a 00                	push   $0x0
    204a:	8b 45 d0             	mov    -0x30(%ebp),%eax
    204d:	8b 10                	mov    (%eax),%edx
    204f:	89 f0                	mov    %esi,%eax
    2051:	e8 7a fe ff ff       	call   1ed0 <printint>
        ap++;
    2056:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    205a:	83 c4 10             	add    $0x10,%esp
      state = 0;
    205d:	31 c9                	xor    %ecx,%ecx
    205f:	e9 6e ff ff ff       	jmp    1fd2 <printf+0x52>
    2064:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    2068:	8b 45 d0             	mov    -0x30(%ebp),%eax
    206b:	8b 10                	mov    (%eax),%edx
        ap++;
    206d:	83 c0 04             	add    $0x4,%eax
    2070:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    2073:	85 d2                	test   %edx,%edx
    2075:	0f 84 8d 00 00 00    	je     2108 <printf+0x188>
        while(*s != 0){
    207b:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    207e:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    2080:	84 c0                	test   %al,%al
    2082:	0f 84 4a ff ff ff    	je     1fd2 <printf+0x52>
    2088:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    208b:	89 d3                	mov    %edx,%ebx
    208d:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    2090:	83 ec 04             	sub    $0x4,%esp
          s++;
    2093:	83 c3 01             	add    $0x1,%ebx
    2096:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    2099:	6a 01                	push   $0x1
    209b:	57                   	push   %edi
    209c:	56                   	push   %esi
    209d:	e8 a1 fd ff ff       	call   1e43 <write>
        while(*s != 0){
    20a2:	0f b6 03             	movzbl (%ebx),%eax
    20a5:	83 c4 10             	add    $0x10,%esp
    20a8:	84 c0                	test   %al,%al
    20aa:	75 e4                	jne    2090 <printf+0x110>
      state = 0;
    20ac:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    20af:	31 c9                	xor    %ecx,%ecx
    20b1:	e9 1c ff ff ff       	jmp    1fd2 <printf+0x52>
    20b6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    20bd:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 10, 1);
    20c0:	83 ec 0c             	sub    $0xc,%esp
    20c3:	b9 0a 00 00 00       	mov    $0xa,%ecx
    20c8:	6a 01                	push   $0x1
    20ca:	e9 7b ff ff ff       	jmp    204a <printf+0xca>
    20cf:	90                   	nop
        putc(fd, *ap);
  ...
  write(fd, &c, 1);
    ...
    20db:	56                   	push   %esi
        putc(fd, *ap);
    20dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    20df:	e8 5f fd ff ff       	call   1e43 <write>
        ap++;
    20e4:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    20e8:	83 c4 10             	add    $0x10,%esp
      state = 0;
    20eb:	31 c9                	xor    %ecx,%ecx
    20ed:	e9 e0 fe ff ff       	jmp    1fd2 <printf+0x52>
    20f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    20f8:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    20fb:	83 ec 04             	sub    $0x4,%esp
    20fe:	e9 2a ff ff ff       	jmp    202d <printf+0xad>
    2103:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    2107:	90                   	nop
          s = "(null)";
    2108:	ba 90 23 00 00       	mov    $0x2390,%edx
        while(*s != 0){
    210d:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    2110:	b8 28 00 00 00       	mov    $0x28,%eax
    2115:	89 d3                	mov    %edx,%ebx
    2117:	e9 74 ff ff ff       	jmp    2090 <printf+0x110>
    211c:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2121:	a1 44 2a 00 00       	mov    0x2a44,%eax
{
    2126:	89 e5                	mov    %esp,%ebp
    2128:	57                   	push   %edi
    2129:	56                   	push   %esi
    212a:	53                   	push   %ebx
    212b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bp = (Header*)ap - 1;
    212e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2131:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    2138:	89 c2                	mov    %eax,%edx
    213a:	8b 00                	mov    (%eax),%eax
    213c:	39 ca                	cmp    %ecx,%edx
    213e:	73 30                	jae    2170 <free+0x50>
    2140:	39 c1                	cmp    %eax,%ecx
    2142:	72 04                	jb     2148 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    2144:	39 c2                	cmp    %eax,%edx
    2146:	72 f0                	jb     2138 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    2148:	8b 73 fc             	mov    -0x4(%ebx),%esi
    214b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    214e:	39 f8                	cmp    %edi,%eax
    2150:	74 30                	je     2182 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    2152:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    2155:	8b 42 04             	mov    0x4(%edx),%eax
    2158:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    215b:	39 f1                	cmp    %esi,%ecx
    215d:	74 3a                	je     2199 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    215f:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    2161:	5b                   	pop    %ebx
  freep = p;
    2162:	89 15 44 2a 00 00    	mov    %edx,0x2a44
}
    2168:	5e                   	pop    %esi
    2169:	5f                   	pop    %edi
    216a:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    2170:	39 c2                	cmp    %eax,%edx
    2172:	72 c4                	jb     2138 <free+0x18>
    2174:	39 c1                	cmp    %eax,%ecx
    2176:	73 c0                	jae    2138 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    2178:	8b 73 fc             	mov    -0x4(%ebx),%esi
    217b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    217e:	39 f8                	cmp    %edi,%eax
    2180:	75 d0                	jne    2152 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    2182:	03 70 04             	add    0x4(%eax),%esi
    2185:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    2188:	8b 02                	mov    (%edx),%eax
    218a:	8b 00                	mov    (%eax),%eax
    218c:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    218f:	8b 42 04             	mov    0x4(%edx),%eax
    2192:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    2195:	39 f1                	cmp    %esi,%ecx
    2197:	75 c6                	jne    215f <free+0x3f>
    p->s.size += bp->s.size;
    2199:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    219c:	89 15 44 2a 00 00    	mov    %edx,0x2a44
    p->s.size += bp->s.size;
    21a2:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    21a5:	8b 4b f8             	mov    -0x8(%ebx),%ecx
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    21bc:	8b 3d 44 2a 00 00    	mov    0x2a44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    21c2:	8d 70 07             	lea    0x7(%eax),%esi
    21c5:	c1 ee 03             	shr    $0x3,%esi
    21c8:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    21cb:	85 ff                	test   %edi,%edi
    21cd:	0f 84 9d 00 00 00    	je     2270 <malloc+0xc0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    21d3:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    21d5:	8b 4a 04             	mov    0x4(%edx),%ecx
    21d8:	39 f1                	cmp    %esi,%ecx
    21da:	73 6a                	jae    2246 <malloc+0x96>
    21dc:	bb 00 10 00 00       	mov    $0x1000,%ebx
    21e1:	39 de                	cmp    %ebx,%esi
    21e3:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    21e6:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    21ed:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    21f0:	eb 17                	jmp    2209 <malloc+0x59>
    21f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    21f8:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    21fa:	8b 48 04             	mov    0x4(%eax),%ecx
    21fd:	39 f1                	cmp    %esi,%ecx
    21ff:	73 4f                	jae    2250 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    2201:	8b 3d 44 2a 00 00    	mov    0x2a44,%edi
    2207:	89 c2                	mov    %eax,%edx
    2209:	39 d7                	cmp    %edx,%edi
    220b:	75 eb                	jne    21f8 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    220d:	83 ec 0c             	sub    $0xc,%esp
    2210:	ff 75 e4             	pushl  -0x1c(%ebp)
    2213:	e8 93 fc ff ff       	call   1eab <sbrk>
  if(p == (char*)-1)
    2218:	83 c4 10             	add    $0x10,%esp
    221b:	83 f8 ff             	cmp    $0xffffffff,%eax
    221e:	74 1c                	je     223c <malloc+0x8c>
  hp->s.size = nu;
    2220:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    2223:	83 ec 0c             	sub    $0xc,%esp
    2226:	83 c0 08             	add    $0x8,%eax
    2229:	50                   	push   %eax
    222a:	e8 f1 fe ff ff       	call   2120 <free>
  return freep;
    222f:	8b 15 44 2a 00 00    	mov    0x2a44,%edx
      if((p = morecore(nunits)) == 0)
    2235:	83 c4 10             	add    $0x10,%esp
    2238:	85 d2                	test   %edx,%edx
    223a:	75 bc                	jne    21f8 <malloc+0x48>
        return 0;
  }
}
    223c:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    2248:	89 fa                	mov    %edi,%edx
    224a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    2250:	39 ce                	cmp    %ecx,%esi
    2252:	74 4c                	je     22a0 <malloc+0xf0>
        p->s.size -= nunits;
    2254:	29 f1                	sub    %esi,%ecx
    2256:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    2259:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    225c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    225f:	89 15 44 2a 00 00    	mov    %edx,0x2a44
}
    2265:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    2268:	83 c0 08             	add    $0x8,%eax
}
    226b:	5b                   	pop    %ebx
    226c:	5e                   	pop    %esi
    226d:	5f                   	pop    %edi
    ...
    226f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    2270:	c7 05 44 2a 00 00 48 	movl   $0x2a48,0x2a44
    2277:	2a 00 00 
    base.s.size = 0;
    227a:	bf 48 2a 00 00       	mov    $0x2a48,%edi
    base.s.ptr = freep = prevp = &base;
    227f:	c7 05 48 2a 00 00 48 	movl   $0x2a48,0x2a48
    2286:	2a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    2289:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    228b:	c7 05 4c 2a 00 00 00 	movl   $0x0,0x2a4c
    2292:	00 00 00 
    if(p->s.size >= nunits){
    2295:	e9 42 ff ff ff       	jmp    21dc <malloc+0x2c>
    229a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    22a0:	8b 08                	mov    (%eax),%ecx
    22a2:	89 0a                	mov    %ecx,(%edx)
    22a4:	eb b9                	jmp    225f <malloc+0xaf>
