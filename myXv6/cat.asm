...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    106c:	68 0b 18 00 00       	push   $0x180b
    1071:	6a 01                	push   $0x1
...
00001090 <cat>:
{
  ...
  if(n < 0){
    ...
    10df:	68 e8 17 00 00       	push   $0x17e8
    10e4:	6a 01                	push   $0x1
    10e6:	e8 d5 03 00 00       	call   14c0 <printf>
      exit();
    10eb:	e8 73 02 00 00       	call   1363 <exit>
    printf(1, "cat: read error\n");
    10f0:	50                   	push   %eax
    10f1:	50                   	push   %eax
    10f2:	68 fa 17 00 00       	push   $0x17fa
    10f7:	6a 01                	push   $0x1
    10f9:	e8 c2 03 00 00       	call   14c0 <printf>
    exit();
    ...
    141c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    148e:	56                   	push   %esi
    148f:	57                   	push   %edi
    1490:	e8 ee fe ff ff       	call   1383 <write>
  while(--i >= 0)
    ...
    14c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1505:	57                   	push   %edi
    1506:	56                   	push   %esi
    1507:	e8 77 fe ff ff       	call   1383 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1539:	ff 24 85 28 18 00 00 	jmp    *0x1828(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    155e:	e8 20 fe ff ff       	call   1383 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    156f:	57                   	push   %edi
    1570:	56                   	push   %esi
    1571:	e8 0d fe ff ff       	call   1383 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    15db:	57                   	push   %edi
    15dc:	56                   	push   %esi
    15dd:	e8 a1 fd ff ff       	call   1383 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    161f:	e8 5f fd ff ff       	call   1383 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    1647:	90                   	nop
          s = "(null)";
    1648:	ba 20 18 00 00       	mov    $0x1820,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1661:	a1 80 1d 00 00       	mov    0x1d80,%eax
{
  ...
  freep = p;
    ...
    16a1:	5b                   	pop    %ebx
  freep = p;
    16a2:	89 15 80 1d 00 00    	mov    %edx,0x1d80
}
    16a8:	5e                   	pop    %esi
    16a9:	5f                   	pop    %edi
    16aa:	5d                   	pop    %ebp
  ...
  freep = p;
    16dc:	89 15 80 1d 00 00    	mov    %edx,0x1d80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16fc:	8b 3d 80 1d 00 00    	mov    0x1d80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    176f:	8b 15 80 1d 00 00    	mov    0x1d80,%edx
    ...
    179c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    179f:	89 15 80 1d 00 00    	mov    %edx,0x1d80
}
    ...
    17af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    17b0:	c7 05 80 1d 00 00 84 	movl   $0x1d84,0x1d80
    17b7:	1d 00 00 
    base.s.size = 0;
    17ba:	bf 84 1d 00 00       	mov    $0x1d84,%edi
    base.s.ptr = freep = prevp = &base;
    17bf:	c7 05 84 1d 00 00 84 	movl   $0x1d84,0x1d84
    17c6:	1d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    17c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    17cb:	c7 05 88 1d 00 00 00 	movl   $0x0,0x1d88
    17d2:	00 00 00 
    if(p->s.size >= nunits){
