...
main(int argc, char *argv[])
{
  ...
  for(i = 2; i < argc; i++){
    ...
    107a:	68 68 1a 00 00       	push   $0x1a68
    107f:	6a 01                	push   $0x1
  ...
  exit();
    ...
    1090:	51                   	push   %ecx
    1091:	51                   	push   %ecx
    1092:	68 48 1a 00 00       	push   $0x1a48
    1097:	6a 02                	push   $0x2
...
000011d0 <grep>:
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    11fd:	50                   	push   %eax
    11fe:	8d 81 80 1e 00 00    	lea    0x1e80(%ecx),%eax
    1204:	50                   	push   %eax
    ...
    p = buf;
    121e:	c7 45 e4 80 1e 00 00 	movl   $0x1e80,-0x1c(%ebp)
    buf[m] = '\0';
    1225:	c6 81 80 1e 00 00 00 	movb   $0x0,0x1e80(%ecx)
    while((q = strchr(p, '\n')) != 0){
  ...
  if(re[0] == '^')
    ...
    12bb:	81 fa 80 1e 00 00    	cmp    $0x1e80,%edx
    ...
    12d0:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
    12d3:	2d 80 1e 00 00       	sub    $0x1e80,%eax
    12d8:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
    12da:	51                   	push   %ecx
    12db:	52                   	push   %edx
    12dc:	68 80 1e 00 00       	push   $0x1e80
      m -= p - buf;
    ...
    167c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    16a9:	0f b6 92 e0 1a 00 00 	movzbl 0x1ae0(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    16ee:	56                   	push   %esi
    16ef:	57                   	push   %edi
    16f0:	e8 ee fe ff ff       	call   15e3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    1729:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
    172c:	8b 75 08             	mov    0x8(%ebp),%esi
  for(i = 0; fmt[i]; i++){
    172f:	0f b6 13             	movzbl (%ebx),%edx
    1732:	84 d2                	test   %dl,%dl
    1734:	74 6a                	je     17a0 <printf+0x80>
  ap = (uint*)(void*)&fmt + 1;
    1736:	8d 45 10             	lea    0x10(%ebp),%eax
    1739:	83 c3 01             	add    $0x1,%ebx
  write(fd, &c, 1);
    173c:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    173f:	31 c9                	xor    %ecx,%ecx
  ap = (uint*)(void*)&fmt + 1;
    1741:	89 45 d0             	mov    %eax,-0x30(%ebp)
    1744:	eb 36                	jmp    177c <printf+0x5c>
    1746:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    174d:	8d 76 00             	lea    0x0(%esi),%esi
    1750:	89 4d d4             	mov    %ecx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    1753:	b9 25 00 00 00       	mov    $0x25,%ecx
      if(c == '%'){
    1758:	83 f8 25             	cmp    $0x25,%eax
    175b:	74 15                	je     1772 <printf+0x52>
  write(fd, &c, 1);
    ...
    1765:	57                   	push   %edi
    1766:	56                   	push   %esi
    1767:	e8 77 fe ff ff       	call   15e3 <write>
    176c:	8b 4d d4             	mov    -0x2c(%ebp),%ecx
      } else {
        putc(fd, c);
    176f:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    1772:	0f b6 13             	movzbl (%ebx),%edx
    1775:	83 c3 01             	add    $0x1,%ebx
    1778:	84 d2                	test   %dl,%dl
    177a:	74 24                	je     17a0 <printf+0x80>
    c = fmt[i] & 0xff;
    177c:	0f b6 c2             	movzbl %dl,%eax
    if(state == 0){
    177f:	85 c9                	test   %ecx,%ecx
    1781:	74 cd                	je     1750 <printf+0x30>
      }
    } else if(state == '%'){
    1783:	83 f9 25             	cmp    $0x25,%ecx
    1786:	75 ea                	jne    1772 <printf+0x52>
      if(c == 'd'){
    1788:	83 f8 25             	cmp    $0x25,%eax
    178b:	0f 84 07 01 00 00    	je     1898 <printf+0x178>
    1791:	83 e8 63             	sub    $0x63,%eax
    1794:	83 f8 15             	cmp    $0x15,%eax
    1797:	77 17                	ja     17b0 <printf+0x90>
    1799:	ff 24 85 88 1a 00 00 	jmp    *0x1a88(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    17b3:	88 55 d4             	mov    %dl,-0x2c(%ebp)
    17b6:	6a 01                	push   $0x1
    17b8:	57                   	push   %edi
    17b9:	56                   	push   %esi
    17ba:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    17be:	e8 20 fe ff ff       	call   15e3 <write>
        putc(fd, c);
    17c3:	0f b6 55 d4          	movzbl -0x2c(%ebp),%edx
  write(fd, &c, 1);
    17c7:	83 c4 0c             	add    $0xc,%esp
    17ca:	88 55 e7             	mov    %dl,-0x19(%ebp)
    17cd:	6a 01                	push   $0x1
    17cf:	57                   	push   %edi
    17d0:	56                   	push   %esi
    17d1:	e8 0d fe ff ff       	call   15e3 <write>
        putc(fd, c);
    17d6:	83 c4 10             	add    $0x10,%esp
      state = 0;
    17d9:	31 c9                	xor    %ecx,%ecx
    17db:	eb 95                	jmp    1772 <printf+0x52>
    17dd:	8d 76 00             	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    17e0:	83 ec 0c             	sub    $0xc,%esp
    17e3:	b9 10 00 00 00       	mov    $0x10,%ecx
    17e8:	6a 00                	push   $0x0
    17ea:	8b 45 d0             	mov    -0x30(%ebp),%eax
    17ed:	8b 10                	mov    (%eax),%edx
    17ef:	89 f0                	mov    %esi,%eax
    17f1:	e8 7a fe ff ff       	call   1670 <printint>
        ap++;
    17f6:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    17fa:	83 c4 10             	add    $0x10,%esp
      state = 0;
    17fd:	31 c9                	xor    %ecx,%ecx
    17ff:	e9 6e ff ff ff       	jmp    1772 <printf+0x52>
    1804:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    1808:	8b 45 d0             	mov    -0x30(%ebp),%eax
    180b:	8b 10                	mov    (%eax),%edx
        ap++;
    180d:	83 c0 04             	add    $0x4,%eax
    1810:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
    1813:	85 d2                	test   %edx,%edx
    1815:	0f 84 8d 00 00 00    	je     18a8 <printf+0x188>
        while(*s != 0){
    181b:	0f b6 02             	movzbl (%edx),%eax
      state = 0;
    181e:	31 c9                	xor    %ecx,%ecx
        while(*s != 0){
    1820:	84 c0                	test   %al,%al
    1822:	0f 84 4a ff ff ff    	je     1772 <printf+0x52>
    1828:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    182b:	89 d3                	mov    %edx,%ebx
  ...
  write(fd, &c, 1);
    ...
    183b:	57                   	push   %edi
    183c:	56                   	push   %esi
    183d:	e8 a1 fd ff ff       	call   15e3 <write>
        while(*s != 0){
    1842:	0f b6 03             	movzbl (%ebx),%eax
    1845:	83 c4 10             	add    $0x10,%esp
    1848:	84 c0                	test   %al,%al
    184a:	75 e4                	jne    1830 <printf+0x110>
      state = 0;
    184c:	8b 5d d4             	mov    -0x2c(%ebp),%ebx
    184f:	31 c9                	xor    %ecx,%ecx
    1851:	e9 1c ff ff ff       	jmp    1772 <printf+0x52>
    ...
    1868:	6a 01                	push   $0x1
    186a:	e9 7b ff ff ff       	jmp    17ea <printf+0xca>
    186f:	90                   	nop
        putc(fd, *ap);
  ...
  write(fd, &c, 1);
    ...
    187b:	56                   	push   %esi
        putc(fd, *ap);
    187c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    187f:	e8 5f fd ff ff       	call   15e3 <write>
        ap++;
    1884:	83 45 d0 04          	addl   $0x4,-0x30(%ebp)
    1888:	83 c4 10             	add    $0x10,%esp
      state = 0;
    188b:	31 c9                	xor    %ecx,%ecx
    188d:	e9 e0 fe ff ff       	jmp    1772 <printf+0x52>
    1892:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        putc(fd, c);
    1898:	88 55 e7             	mov    %dl,-0x19(%ebp)
  write(fd, &c, 1);
    189b:	83 ec 04             	sub    $0x4,%esp
    189e:	e9 2a ff ff ff       	jmp    17cd <printf+0xad>
    18a3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    18a7:	90                   	nop
          s = "(null)";
    18a8:	ba 7e 1a 00 00       	mov    $0x1a7e,%edx
        while(*s != 0){
    18ad:	89 5d d4             	mov    %ebx,-0x2c(%ebp)
    18b0:	b8 28 00 00 00       	mov    $0x28,%eax
    18b5:	89 d3                	mov    %edx,%ebx
    18b7:	e9 74 ff ff ff       	jmp    1830 <printf+0x110>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    18c1:	a1 80 22 00 00       	mov    0x2280,%eax
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    18d8:	89 c2                	mov    %eax,%edx
    18da:	8b 00                	mov    (%eax),%eax
    18dc:	39 ca                	cmp    %ecx,%edx
    18de:	73 30                	jae    1910 <free+0x50>
    18e0:	39 c1                	cmp    %eax,%ecx
    18e2:	72 04                	jb     18e8 <free+0x28>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    18e4:	39 c2                	cmp    %eax,%edx
    18e6:	72 f0                	jb     18d8 <free+0x18>
      break;
  if(bp + bp->s.size == p->s.ptr){
    18e8:	8b 73 fc             	mov    -0x4(%ebx),%esi
    18eb:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    18ee:	39 f8                	cmp    %edi,%eax
    18f0:	74 30                	je     1922 <free+0x62>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
    18f2:	89 43 f8             	mov    %eax,-0x8(%ebx)
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    18f5:	8b 42 04             	mov    0x4(%edx),%eax
    18f8:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    18fb:	39 f1                	cmp    %esi,%ecx
    18fd:	74 3a                	je     1939 <free+0x79>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
    18ff:	89 0a                	mov    %ecx,(%edx)
  } else
    p->s.ptr = bp;
  freep = p;
}
    1901:	5b                   	pop    %ebx
  freep = p;
    1902:	89 15 80 22 00 00    	mov    %edx,0x2280
}
    1908:	5e                   	pop    %esi
    1909:	5f                   	pop    %edi
    190a:	5d                   	pop    %ebp
    ...
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1910:	39 c2                	cmp    %eax,%edx
    1912:	72 c4                	jb     18d8 <free+0x18>
    1914:	39 c1                	cmp    %eax,%ecx
    1916:	73 c0                	jae    18d8 <free+0x18>
  if(bp + bp->s.size == p->s.ptr){
    1918:	8b 73 fc             	mov    -0x4(%ebx),%esi
    191b:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    191e:	39 f8                	cmp    %edi,%eax
    1920:	75 d0                	jne    18f2 <free+0x32>
    bp->s.size += p->s.ptr->s.size;
    1922:	03 70 04             	add    0x4(%eax),%esi
    1925:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    1928:	8b 02                	mov    (%edx),%eax
    192a:	8b 00                	mov    (%eax),%eax
    192c:	89 43 f8             	mov    %eax,-0x8(%ebx)
  if(p + p->s.size == bp){
    192f:	8b 42 04             	mov    0x4(%edx),%eax
    1932:	8d 34 c2             	lea    (%edx,%eax,8),%esi
    1935:	39 f1                	cmp    %esi,%ecx
    1937:	75 c6                	jne    18ff <free+0x3f>
    p->s.size += bp->s.size;
    1939:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
    193c:	89 15 80 22 00 00    	mov    %edx,0x2280
    p->s.size += bp->s.size;
    1942:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    1945:	8b 4b f8             	mov    -0x8(%ebx),%ecx
    1948:	89 0a                	mov    %ecx,(%edx)
}
    194a:	5b                   	pop    %ebx
    194b:	5e                   	pop    %esi
    194c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    195c:	8b 3d 80 22 00 00    	mov    0x2280,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1962:	8d 70 07             	lea    0x7(%eax),%esi
    1965:	c1 ee 03             	shr    $0x3,%esi
    1968:	83 c6 01             	add    $0x1,%esi
  if((prevp = freep) == 0){
    196b:	85 ff                	test   %edi,%edi
    196d:	0f 84 9d 00 00 00    	je     1a10 <malloc+0xc0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1973:	8b 17                	mov    (%edi),%edx
    if(p->s.size >= nunits){
    1975:	8b 4a 04             	mov    0x4(%edx),%ecx
    1978:	39 f1                	cmp    %esi,%ecx
    197a:	73 6a                	jae    19e6 <malloc+0x96>
    197c:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1981:	39 de                	cmp    %ebx,%esi
    1983:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    1986:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    198d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    1990:	eb 17                	jmp    19a9 <malloc+0x59>
    1992:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1998:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    199a:	8b 48 04             	mov    0x4(%eax),%ecx
    199d:	39 f1                	cmp    %esi,%ecx
    199f:	73 4f                	jae    19f0 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    19a1:	8b 3d 80 22 00 00    	mov    0x2280,%edi
    19a7:	89 c2                	mov    %eax,%edx
    19a9:	39 d7                	cmp    %edx,%edi
    19ab:	75 eb                	jne    1998 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    19ad:	83 ec 0c             	sub    $0xc,%esp
    19b0:	ff 75 e4             	pushl  -0x1c(%ebp)
    19b3:	e8 93 fc ff ff       	call   164b <sbrk>
  if(p == (char*)-1)
    19b8:	83 c4 10             	add    $0x10,%esp
    19bb:	83 f8 ff             	cmp    $0xffffffff,%eax
    19be:	74 1c                	je     19dc <malloc+0x8c>
  hp->s.size = nu;
    19c0:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    19c3:	83 ec 0c             	sub    $0xc,%esp
    19c6:	83 c0 08             	add    $0x8,%eax
    19c9:	50                   	push   %eax
    19ca:	e8 f1 fe ff ff       	call   18c0 <free>
  return freep;
    19cf:	8b 15 80 22 00 00    	mov    0x2280,%edx
      if((p = morecore(nunits)) == 0)
    19d5:	83 c4 10             	add    $0x10,%esp
    19d8:	85 d2                	test   %edx,%edx
    19da:	75 bc                	jne    1998 <malloc+0x48>
        return 0;
  }
}
    ...
    19e8:	89 fa                	mov    %edi,%edx
    19ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    19f0:	39 ce                	cmp    %ecx,%esi
    19f2:	74 4c                	je     1a40 <malloc+0xf0>
        p->s.size -= nunits;
    19f4:	29 f1                	sub    %esi,%ecx
    19f6:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    19f9:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    19fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    19ff:	89 15 80 22 00 00    	mov    %edx,0x2280
}
    1a05:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    1a08:	83 c0 08             	add    $0x8,%eax
}
    1a0b:	5b                   	pop    %ebx
    1a0c:	5e                   	pop    %esi
    1a0d:	5f                   	pop    %edi
    ...
    1a0f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1a10:	c7 05 80 22 00 00 84 	movl   $0x2284,0x2280
    1a17:	22 00 00 
    base.s.size = 0;
    1a1a:	bf 84 22 00 00       	mov    $0x2284,%edi
    base.s.ptr = freep = prevp = &base;
    1a1f:	c7 05 84 22 00 00 84 	movl   $0x2284,0x2284
    1a26:	22 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1a29:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    1a2b:	c7 05 88 22 00 00 00 	movl   $0x0,0x2288
    1a32:	00 00 00 
    if(p->s.size >= nunits){
    1a35:	e9 42 ff ff ff       	jmp    197c <malloc+0x2c>
    1a3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    1a40:	8b 08                	mov    (%eax),%ecx
    1a42:	89 0a                	mov    %ecx,(%edx)
    1a44:	eb b9                	jmp    19ff <malloc+0xaf>
