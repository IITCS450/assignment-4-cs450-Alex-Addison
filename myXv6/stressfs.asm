    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "stressfs starting\n");
    102b:	68 18 18 00 00       	push   $0x1818
    1030:	6a 01                	push   $0x1
  char path[] = "stressfs0";
  ...
  printf(1, "write %d\n", i);
    1081:	68 2b 18 00 00       	push   $0x182b
    1086:	6a 01                	push   $0x1
...
//    printf(fd, "%d\n", i);
  ...
  printf(1, "read\n");
    10d0:	58                   	pop    %eax
    10d1:	5a                   	pop    %edx
    10d2:	68 35 18 00 00       	push   $0x1835
    10d7:	6a 01                	push   $0x1
    ...
    144c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1479:	0f b6 92 9c 18 00 00 	movzbl 0x189c(%edx),%edx
  ...
  write(fd, &c, 1);
    ...
    14be:	56                   	push   %esi
    14bf:	57                   	push   %edi
    14c0:	e8 ee fe ff ff       	call   13b3 <write>
  while(--i >= 0)
    ...
    14f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1535:	57                   	push   %edi
    1536:	56                   	push   %esi
    1537:	e8 77 fe ff ff       	call   13b3 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1569:	ff 24 85 44 18 00 00 	jmp    *0x1844(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    158e:	e8 20 fe ff ff       	call   13b3 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    159f:	57                   	push   %edi
    15a0:	56                   	push   %esi
    15a1:	e8 0d fe ff ff       	call   13b3 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    160b:	57                   	push   %edi
    160c:	56                   	push   %esi
    160d:	e8 a1 fd ff ff       	call   13b3 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    164f:	e8 5f fd ff ff       	call   13b3 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    1677:	90                   	nop
          s = "(null)";
    1678:	ba 3b 18 00 00       	mov    $0x183b,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1691:	a1 54 1b 00 00       	mov    0x1b54,%eax
{
  ...
  freep = p;
    ...
    16d1:	5b                   	pop    %ebx
  freep = p;
    16d2:	89 15 54 1b 00 00    	mov    %edx,0x1b54
}
    16d8:	5e                   	pop    %esi
    16d9:	5f                   	pop    %edi
    16da:	5d                   	pop    %ebp
  ...
  freep = p;
    170c:	89 15 54 1b 00 00    	mov    %edx,0x1b54
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    172c:	8b 3d 54 1b 00 00    	mov    0x1b54,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    179f:	8b 15 54 1b 00 00    	mov    0x1b54,%edx
    ...
    17cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    17cf:	89 15 54 1b 00 00    	mov    %edx,0x1b54
}
    ...
    17df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    17e0:	c7 05 54 1b 00 00 58 	movl   $0x1b58,0x1b54
    17e7:	1b 00 00 
    base.s.size = 0;
    17ea:	bf 58 1b 00 00       	mov    $0x1b58,%edi
    base.s.ptr = freep = prevp = &base;
    17ef:	c7 05 58 1b 00 00 58 	movl   $0x1b58,0x1b58
    17f6:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    17f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    17fb:	c7 05 5c 1b 00 00 00 	movl   $0x0,0x1b5c
    1802:	00 00 00 
    if(p->s.size >= nunits){
