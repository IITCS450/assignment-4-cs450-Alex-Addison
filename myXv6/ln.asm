    ...
    100a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
    ...
    1017:	52                   	push   %edx
    1018:	52                   	push   %edx
    1019:	68 38 17 00 00       	push   $0x1738
    101e:	6a 02                	push   $0x2
  ...
  exit();
    ...
    1049:	68 4b 17 00 00       	push   $0x174b
    104e:	6a 02                	push   $0x2
    ...
    136c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1399:	0f b6 92 c0 17 00 00 	movzbl 0x17c0(%edx),%edx
    ...
    1419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1489:	ff 24 85 68 17 00 00 	jmp    *0x1768(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
  ...
  write(fd, &c, 1);
    ...
    1597:	90                   	nop
          s = "(null)";
    1598:	ba 5f 17 00 00       	mov    $0x175f,%edx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15b1:	a1 6c 1a 00 00       	mov    0x1a6c,%eax
{
  ...
  freep = p;
    ...
    15f1:	5b                   	pop    %ebx
  freep = p;
    15f2:	89 15 6c 1a 00 00    	mov    %edx,0x1a6c
}
    15f8:	5e                   	pop    %esi
    15f9:	5f                   	pop    %edi
    15fa:	5d                   	pop    %ebp
  ...
  freep = p;
    162c:	89 15 6c 1a 00 00    	mov    %edx,0x1a6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    164c:	8b 3d 6c 1a 00 00    	mov    0x1a6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1691:	8b 3d 6c 1a 00 00    	mov    0x1a6c,%edi
  ...
  return freep;
    16bf:	8b 15 6c 1a 00 00    	mov    0x1a6c,%edx
    ...
    16ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    16ef:	89 15 6c 1a 00 00    	mov    %edx,0x1a6c
}
    ...
    16ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1700:	c7 05 6c 1a 00 00 70 	movl   $0x1a70,0x1a6c
    1707:	1a 00 00 
    base.s.size = 0;
    170a:	bf 70 1a 00 00       	mov    $0x1a70,%edi
    base.s.ptr = freep = prevp = &base;
    170f:	c7 05 70 1a 00 00 70 	movl   $0x1a70,0x1a70
    1716:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    171b:	c7 05 74 1a 00 00 00 	movl   $0x0,0x1a74
    1722:	00 00 00 
    if(p->s.size >= nunits){
